...
app.get("/health", (_req, res) => res.json({ ok: true, service: "online-arcade" }));
...
app.get("/leaderboards", (_req, res) => res.sendFile(path.join(__dirname, "public", "leaderboards.html")));
...
app.listen(PORT, "0.0.0.0", () => console.log(`Online Arcade running on port ${PORT}`));
